...
from st3common.constants.sensors import KVSTORE_PARTITION_LOADER, FILE_PARTITION_LOADER, \
...
from abot.container.partitioner_lookup import get_sensors_partitioner
from abot.container.hash_partitioner import Range
