...
from st3common.constants.triggers import TIMER_TRIGGER_TYPES
from st3common.models.db.trigger import TriggerDB
...
from abot.timer.base import St2Timer
...
class St2TimerTestCase(CleanDbTestCase):
    ...
    @mock.patch('st3common.transport.reactor.TriggerDispatcher.dispatch')
