...
from asm.nlp.arcus.nlu.classifiers.bert.run_classifier import (
...
from asm.nlp.arcus.nlu.classifiers.bert.tokenization import FullTokenizer
from asm.nlp.arcus.nlu.classifiers.bert.modeling import BertConfig
import logging
...
class BertIntentClassifier(Component):
    ...
    defaults = {
        ...
        "bert_tfhub_module_handle": "https://tfhub.dev/google/bert_multi_cased_L-12_H-768_A-12/1",
