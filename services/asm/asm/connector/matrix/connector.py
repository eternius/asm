...
from asm.utils.events import Message, Image, File
...
class ConnectorMatrix(Connector):
    ...
    def __init__(self, config, asm=None):  # noqa: D107
    ...
    async def _send_file(self, file_event):
        ...
        name = file_event.name or "asm_upload"
