...
from st3common.constants import action as action_constants
from st3common.constants.keyvalue import FULL_SYSTEM_SCOPE
from st3common.constants.rule_enforcement import RULE_ENFORCEMENT_STATUS_SUCCEEDED
from st3common.constants.rule_enforcement import RULE_ENFORCEMENT_STATUS_FAILED
from st3common.expressions.functions import data
from st3common.models.db.trigger import TriggerInstanceDB
from st3common.models.db.execution import ActionExecutionDB
from st3common.models.db.liveaction import LiveActionDB
from st3common.models.db.keyvalue import KeyValuePairDB
from st3common.persistence.keyvalue import KeyValuePair
from st3common.persistence.rule_enforcement import RuleEnforcement
from st3common.services import action as action_service
from st3common.bootstrap import runnersregistrar as runners_registrar
from st3common.util import casts
from st3common.util import reference
from st3common.util import date as date_utils
from abot.rules.enforcer import RuleEnforcer
...
class RuleEnforcerTestCase(BaseRuleEnforcerTestCase):
    ...
    @mock.patch.object(action_service, 'request', mock.MagicMock(
        return_value=(MOCK_LIVEACTION, MOCK_EXECUTION)))
    @mock.patch.object(RuleEnforcement, 'add_or_update', mock.MagicMock())
    @mock.patch('st3common.util.param.get_config',
