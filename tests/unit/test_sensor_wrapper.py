...
from st3common.util.monkey_patch import monkey_patch
monkey_patch()

import st2tests.config as tests_config
from st2tests.base import TESTS_CONFIG_PATH
from st3common.models.db.trigger import TriggerDB
from abot.container.sensor_wrapper import SensorWrapper
from abot.sensor.base import Sensor, PollingSensor
