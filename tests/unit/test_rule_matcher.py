...
from st3common.models.api.rule import RuleAPI
from st3common.models.db.trigger import (TriggerDB, TriggerTypeDB)
from st3common.persistence.rule import Rule
from st3common.persistence.trigger import (TriggerType, Trigger)
from st3common.services.triggers import get_trigger_db_by_ref
from st3common.util import date as date_utils
import abot.container.utils as container_utils
from abot.rules.matcher import RulesMatcher
...
class RuleMatcherTestCase(CleanDbTestCase):
    ...
    @mock.patch('st3common.operators.get_operator',
