...
from st3common.models.db.action import ActionDB
from st3common.models.db.rule import RuleDB, ActionExecutionSpecDB
from st3common.models.db.trigger import TriggerDB, TriggerInstanceDB
from st3common.util import reference
from st3common.util import date as date_utils
from abot.rules.filter import RuleFilter
...
class FilterTest(DbTestCase):
    ...
    @mock.patch('st3common.util.templating.KeyValueLookup')
