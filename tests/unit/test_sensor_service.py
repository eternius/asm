...
from abot.container.sensor_wrapper import SensorService
from st3common.constants.keyvalue import SYSTEM_SCOPE
from st3common.constants.keyvalue import USER_SCOPE
...
class SensorServiceTestCase(unittest2.TestCase):
    ...
    @mock.patch('st3common.services.triggers.get_trigger_type_db',
    ...
    @mock.patch('st3common.services.triggers.get_trigger_type_db',
                mock.MagicMock(return_value=TriggerTypeDBMock(TEST_SCHEMA)))
    @mock.patch('st3common.services.triggers.get_trigger_db_by_ref',
