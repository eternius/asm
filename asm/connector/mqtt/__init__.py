...
class Mqtt(Connector):
    ...
    async def connect(self):
        ...
        self.client.set_auth_credentials(os.getenv('MQTT_USER', "arcus"), os.getenv('MQTT_PASSWORD', "arcus"))
        await self.client.connect(os.getenv('MQTT_HOST', "vernemq"), 1883, keepalive=60, version=MQTTv311)

        _LOGGER.info("Connected to VerneMQ")
